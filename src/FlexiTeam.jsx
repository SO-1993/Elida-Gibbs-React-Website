...
function FlexiTeam() {
  return (
    <div className="flexi-team-goalkeepers">
      <h2>Goalkeepers</h2>
      <div className="flexi-team-goalkeeper-list">
        <div className="flexi-team-goalkeeper">
          <p>Adam Fenwick</p>
          <img
      ...
      <div className="flexi-team-defenders">
        <h2>Defenders</h2>
        <div className="flexi-team-defender-list">
          <div className="flexi-team-defender">
            <p>Tom Hammond</p>
            <img
      ...
      <div className="flexi-team-midfielders">
        <h2>Midfielders</h2>
        <div className="flexi-team-midfielder-list">
          <div className="flexi-team-midfielder">
            <p>Danny Kreft</p>
            <img
      ...
      <div className="flexi-team-attackers">
        <h2>Attackers</h2>
        <div className="flexi-team-attacker-list">
          <div className="flexi-team-attacker">
            <p>Oli Baron</p>
            <img
